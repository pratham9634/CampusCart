...
export default function Footer() {
  return (
    <footer className="relative mt-1">
      ...
      {/* Main Content */}
      <div className="relative container mx-auto px-4 md:px-12 py-12 grid grid-cols-1 lg:grid-cols-4 gap-10 text-black">
        {/* Brand */}
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
          <h2 className="text-2xl md:text-3xl font-extrabold">Campus Cart</h2>
          ...
          <div className="flex items-center space-x-4 mt-5">
            ...
            <Link
              href="https://github.com/pratham9634/CampusCart"
              target="_blank"
            >
              <Github
                size={22}
