...
const WhyChoose = () => {
  return (
    <section className="w-full px-6 py-16 bg-white text-center">
      <h1 className="text-2xl sigmar font-[900] text-center w-full mb-12 relative inline-block text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-purple-600 to-red-500 animate-text">
  Why Choose Us
