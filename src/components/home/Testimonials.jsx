...
const Testimonials = () => {
  return (
    <section className="w-full h-full px-4 py-24 bg-gradient-to-br from-green-50 via-teal-50 to-blue-50">
      <h1 className="text-2xl sigmar font-[900] text-center w-full mb-16 relative inline-block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-500 to-pink-500 animate-text">
        What Our Users Say
